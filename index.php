...
$arr = array(
    ...
    array("titulo" => "Moraes devolve processos, e STF retomará julgamento de regras do governo para armas", "imagem" => "https://headtopics.com/images/2021/9/9/veja/moraes-d-primeiro-passo-para-testar-ameaca-de-bolsonaro-contra-o-stf-via-radaronline-1435721310152318982.webp", "Descricao" => "O Supremo Tribunal Federal marcou para o próximo dia 17 a retomada do julgamento de ações que questionam a política armamentista do governo Bolsonaro.
...
<div class="container">
    <div class="center card panel red lighten-1 section hoverable" style ="padding: 10px;">
                ...
                ?>
            <div class="row">
                <a class="white-text" href='<?php echo $value["Link"]?>' style=" font-weight: 500; font-size: 30px; "><?php echo $value["titulo"]; ?></a>
            </div>
            <div class="row">
                <a href='<?php echo $value["Link"]?>'><img class="responsive-img" width="800" src="<?php echo $value["imagem"] ?>"></a>
            </div>
            <div class="row">
                <a class="white-text" style=" font-weight: 500; font-size: 20px; "><?php echo $value["Descricao"]; ?></a>
            </div>
    </div>
</div>
